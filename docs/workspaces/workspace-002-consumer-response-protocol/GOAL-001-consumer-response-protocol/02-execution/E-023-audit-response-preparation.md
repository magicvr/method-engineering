...
用户已选择窄幅扩展 exchange，冲突处理路径见 [D-009](../01-decision/D-009-exchange-process-material-scope.md)，修订事实见 [E-024](E-024-exchange-contract-extension.md)。上文保留裁决前准备事实。F-001 / I-008 仍 open，等待独立复审；实际链条材料未写入。
