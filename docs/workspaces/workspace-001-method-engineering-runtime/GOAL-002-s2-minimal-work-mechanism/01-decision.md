...
| P2 | `01-decision/D-003-s2-object-hosting.md`、`01-decision/D-004-s2-repository-hosting-correction.md` | 只冻结由运行责任推出的最小对象、记录边界与承载方案；D-004 修正为仓库级承载。 |
...
| D-003 | 2026-09-18 | P2 最小工作对象与承载方案（原方案） | superseded | `01-decision/D-003-s2-object-hosting.md` |
| D-004 | 2026-09-18 | S2 运行记录改为仓库级承载 | accepted | `01-decision/D-004-s2-repository-hosting-correction.md` |
