...
- [ ] D-002 的运行责任、状态转换、授权边界、反馈和追踪问句均有对应的最小记录/承载需求说明。
...
| 阶段 | 名称 | 状态 | 退出条件 |
|------|------|------|----------|
| **P1** | 运行责任→记录需求映射 | 未开始 | D-002 的责任位置、状态转换、追踪问句和反馈路由均完成最小记录需求核对；I-201 仍可追踪。 |
...
|----|------|-----------------|----------|--------------|-----------------|------|-------------|-------------|
| I-201 | required | 从 D-002 已冻结的运行责任反推出哪些最小工作对象、记录边界和承载位置。 | P2 方案冻结、P3/S2 退出 | P2 | 建立责任→记录需求映射，逐项说明保留理由并核对无第二状态源。 | open | 不延期；P2 方案冻结前处理。 | 待 P1 事实与映射记录。 |
